...
const StyledTitle = styled.h1`
  ...
  font-size: ${(props) => (props.size === "sm" ? "28px" : "32px")};
  margin-bottom: 10px;
  font-family: "SöhneBreit Buch", sans-serif;
  text-transform: ${(props) => (props.lowercase ? "none" : "uppercase")};
  @media ${(props) => props.theme.minWidth.sm} {
    margin-bottom: ${(props) => (props.size === "sm" ? "10px" : "40px")};
    font-size: ${(props) => (props.size ? "35px" : "45px")};
  }
  @media ${(props) => props.theme.minWidth.md} {
    font-size: ${(props) => (props.size === "sm" ? "35px" : "50px")};
  }
  @media ${(props) => props.theme.minWidth.xl} {
    font-size: ${(props) => (props.size === "sm" ? "45px" : "60px")};
  }
`;
