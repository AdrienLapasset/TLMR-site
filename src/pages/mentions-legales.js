        ...
        <StyledGrid>
          ...
          <div>
            ...
            <p id="politique-de-confidentialite">
              ...
              au R.C.S de Roubaix sous le n° 424 761 419 et dont le siège social
              est situé 2 rue Kellerman à Roubaix (59100). Conformément aux
        ...
        <StyledGrid>
          ...
          <div>
            ...
            <p>
              ...
              tlmr-avocats.com est prise en application des articles 13 et 14 du
            ...
            <p>
              ...
              susceptible de collecter les données suivantes vous concernant en
            ...
            <p>
              ...
              pourront être divulguées en application d’une loi, d’un règlement
              ou en vertu d’une décision d’une autorité réglementaire ou
              judiciaire compétente. De manière générale, nous nous engageons à
              nous conformer à toutes les règles légales qui pourraient
              empêcher, limiter ou réglementer la diffusion d’informations ou de
              données.
            </p>
            ...
            <p>
              ...
              au-delà du temps nécessaire à la réalisation des finalités
              décrites dans la présente Politique. En cas de proposition de
              rendez-vous du Cabinet non suivie, ou d’échanges électroniques
              auxquels il ne sera pas donné suite, l’ensemble des données
              personnelles liées au dossier collectées fera l’objet d’une
              suppression dans un délai maximal de 25 semaines aux fins de
              protection de la vie privée. Les données d’identification (noms,
              prénoms et adresse mail et téléphone) pourront être conservées
              pendant une période de 3 années aux fins de sollicitation
              personnalisée après le dernier contact. Dans tous les autres cas,
              les données seront conservées pendant une durée maximale de 5
              années à compter du dernier acte juridique ou judiciaire réalisé
              par le Cabinet sauf prescription particulière. Au-delà, elles
              pourront être anonymisées ou archivées à des fins statistiques et
              probatoires.
            </p>
        ...
        <StyledGrid>
          ...
          <div>
            ...
            <p>
              ...
              que vous avez consultées, la date et l’heure de la consultation…)
