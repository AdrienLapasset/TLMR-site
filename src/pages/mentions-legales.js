    ...
    <Layout>
      ...
      <StyledGrid>
        ...
        <div>
          ...
          <p>
            La Politique de confidentialité des données du site tlmr-avocats.com
            est prise en application des articles 13 et 14 du Règlement européen
            Général sur la Protection des Données (2016/679) et de l’article 32
            de la loi Informatique et Libertés du 6 janvier 1978.
          </p>
          <h3>Nature des données collectées</h3>
          <p>
            Dans le cadre de l’exploitation du Site, le Cabinet est susceptible
            de collecter les données suivantes vous concernant en tant que
          ...
          <p>
            Dans le cadre de l’exploitation du Site, le traitement de données
            personnelles a pour finalité la gestion des clients, la
            sollicitation personnalisée, les opérations de fidélisation,
            l’élaboration de statistiques, la gestion des demandes de droit
            d’accès, de rectification et d’opposition, la gestion des avis des
            personnes sur le Cabinet. Plus globalement, dans le cadre du
          ...
          <p>
            Pour l’ensemble de vos données personnelles, vous pouvez exercer les
            droits suivants auprès du responsable de traitement, le Cabinet,
            ...
            <ul>
              ...
              <li>
                – Droit de demander une limitation du traitement relatif à sa
                personne ;
              </li>
              <li>
            ...
            Dans l’hypothèse où vous considèreriez que vos données n’ont pas été
            protégées, vous disposez également du droit d’introduire une
          ...
          <p>
            ...
            limiter ou réglementer la diffusion d’informations ou de données.
          </p>
          <h3>Durée de conservation des données</h3>
          <p>
            Vos données sont traitées et conservées par le cabinet dès votre
            prise d’attache, y compris pour le simple établissement d’un devis
            ou lors de la prise de rendez-vous. Elles ne sont pas conservées
            au-delà du temps nécessaire à la réalisation des finalités décrites
            dans la présente Politique. En cas de proposition de rendez-vous du
            Cabinet non suivie, ou d’échanges électroniques auxquels il ne sera
            pas donné suite, l’ensemble des données personnelles liées au
            dossier collectées fera l’objet d’une suppression dans un délai
            maximal de 25 semaines aux fins de protection de la vie privée. Les
            données d’identification (noms, prénoms et adresse mail et
            téléphone) pourront être conservées pendant une période de 3 années
            aux fins de sollicitation personnalisée après le dernier contact.
            Dans tous les autres cas, les données seront conservées pendant une
            durée maximale de 5 années à compter du dernier acte juridique ou
            judiciaire réalisé par le Cabinet sauf prescription particulière.
            Au-delà, elles pourront être anonymisées ou archivées à des fins
            statistiques et probatoires.
          </p>
          <h3>Transfert des données en dehors de l’Union Européenne</h3>
          <p>
            Le Cabinet s’engage à respecter la réglementation applicable
            relative aux transferts des données vers des pays étrangers offrant
            un niveau de protection équivalent, et à obtenir une autorisation
            auprès de la CNIL pour procéder à un tel transfert dans le cas où le
            pays destinataire ne disposerait pas d’un tel niveau de protection.
          </p>
          ...
          <h3>Demandes</h3>
          <p>
            Pour toute demande concernant la politique de protection des données
            des utilisateur du Site, et pour exercer vos droits vous pouvez
            contacter le Cabinet à l’adresse&nbsp;
            <a href="mailto:contact@tlmr-avocats.com">
              contact@tlmr-avocats.com
            </a>
            .
      ...
      <StyledGrid>
        ...
        <div>
          ...
          <p>
            ...
            <br /> Vous êtes informé que le Cabinet est susceptible de déposer
            des cookies sur votre terminal. Le cookie enregistre des
            informations relatives à la navigation sur le service (les pages que
            vous avez consultées, la date et l’heure de la consultation…) que
          ...
          <h3>Demandes</h3>
          <p>
            Pour toute demande concernant les cookies, vous pouvez contacter le
            Cabinet à l’adresse&nbsp;
            <a href="mailto:contact@tlmr-avocats.com">
              contact@tlmr-avocats.com
            </a>
